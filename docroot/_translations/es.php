...
$translate['jumbotron_p'] = 'Wes Jones es un desarollador de <strong>Rochester, Nueva York</strong> que vive en Cuenca, Ecuador. Él se especializa en <strong>Drupal</strong> y Backdrop CMS, y desarollo de páginas web multilingües en <strong>español</strong> y <strong>chino mandarín</strong> también.';
$translate['cta_button_text'] = 'Pónganse en contacto con Wes para su próximo proyecto';
$translate['feature1_h1'] = 'Experto multilingües';
$translate['feature1_p'] = 'Wes se habla español y chino mandarín con fluidez, y tiene la experiencia en la creación de sitios web multilingües, utilizando el sistema Drupal.';
$translate['feature2_h1'] = 'Drupal consultante';
